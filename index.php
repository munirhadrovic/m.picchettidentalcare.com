...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
		    <h1>Mobile Site | <a href="http://m.drdavidmcneil.com/" rel="external">Classic Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Financing</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Office Hours</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
		  ...
		  <h2>Welcome to Picchetti Dental Care</h2>
            <p>Learn more about services, meet our team, and find answers to some of your questions as you explore
                our Website. We look forward to supporting your dental health goals so give us a call to set up an appointment with our
                office. When you visit Picchetti Dental Care, you'll be treated like family. We have created a warm, inviting, and friendly place for you.
                Each member of our staff is committed to clinical excellence, patient care, and continuing education.</p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Meet the Doctors</a></li>
